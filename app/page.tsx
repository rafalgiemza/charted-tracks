...
export const metadata: Metadata = {
  title: "ChartedTracks — Music Chart History",
  description:
    ...
    return (
      <main className="container mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Run <code className="bg-muted px-1 rounded">pnpm db:seed</code> to
          load data.
        </p>
      </main>
    );
      ...
      <section>
        ...
        >
          ...
          <div className="hidden sm:block shrink-0">
            ...
            <SparkLine data={numberOne.sparkData} color="hsl(38, 92%, 50%)" />
          </div>
        </Link>
      </section>
